 ...
 * @author MILTON
 */
public class agregarIdiomaDetalle extends javax.swing.JFrame {
    Operaciones operaciones;
    DetalleLibro frameDetalle;
    /**
     * Creates new form agregarIdiomaDetalle
     */
    public agregarIdiomaDetalle(DetalleLibro nuevo) {
        initComponents();
        frameDetalle = nuevo;
    ...
    private void cancelarIdiomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarIdiomaActionPerformed
        ...
        this.frameDetalle.setEnabled(true);
        this.frameDetalle.setVisible(true);
        this.dispose();
    ...
    private void AgregarIdiomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarIdiomaActionPerformed
        ...
        if (!campoNuevoIdioma.getText().isEmpty()){
            ...
            frameDetalle.modeloComboIdioma.removeAllElements();
            frameDetalle.operaciones.cargarIdioma(frameDetalle.modeloComboIdioma);
...
//            java.util.logging.Logger.getLogger(agregarIdiomaDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new agregarIdiomaDetalle().setVisible(true);
//            }
//        });
//    }
